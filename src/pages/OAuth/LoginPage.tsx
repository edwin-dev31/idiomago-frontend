  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-black px-4">
      ...
      <motion.div
        ...
        className="bg-white/80 dark:bg-[#191919] dark:border-[#424242] border backdrop-blur-sm p-4 sm:p-8 lg:p-10 rounded-3xl shadow-xl max-w-xs mx-auto sm:max-w-sm lg:max-w-md"
      >
        <h2 className="text-3xl lg:text-4xl font-bold text-center text-blue-900 mb-6 dark:text-[#38b6ff]">LOGIN</h2>
        <form className="space-y-4" onSubmit={handleLogin}>
          <div className="relative">
            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-400 h-4 w-4 lg:h-5 lg:w-5" />
            <Input
              name="email"
              type="email"
              placeholder="Email"
              ...
              className="pl-10 h-10 lg:h-12 rounded-xl bg-blue-50/50 border-blue-100 
                dark:bg-[#2a2a2a] dark:border-[#424242] text-black dark:text-white 
                placeholder:text-gray-400 dark:placeholder:text-gray-500 lg:text-lg"
          ...
          <div className="relative">
            ...
            {showPassword ? (
              <EyeOff
                ...
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400 cursor-pointer h-4 w-4 lg:h-5 lg:w-5"
              />
            ) : (
              <Eye
          ...
          <Button
            type="submit"
            className="w-full h-10 lg:h-12 bg-blue-500 hover:bg-blue-600 rounded-xl text-lg lg:text-xl font-semibold dark:text-white "
          >
            Login
          </Button>
          ...
          <div className="space-y-2">
            <Button
              variant="outline"
              className="w-full h-10 lg:h-12 rounded-xl flex items-center justify-center space-x-2 lg:text-lg"
              onClick={() =>
            ...
            >
              <FaGithub className="w-4 h-4 lg:w-5 lg:h-5 text-gray-800 dark:text-white" />
